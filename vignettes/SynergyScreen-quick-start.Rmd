...
First, load a design file^[The difference between auto-generated design and the design that was actually used is that controls are in rows G and H in the first and A and H in the second.] and a file with screening data, e.g. ODs of plate wells.
```{r Read in the data}
